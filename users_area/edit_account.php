...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <div class="form-outline mb-4">
            <input type="text" class="form-control w-50 m-auto" value="<?php echo $user_iname ?>" name="user_username">
        </div>
        <div class="form-outline mb-4">
        ...
        <div class="form-outline mb-4">
            ...
            <img src="./user_images/<?php $user_image ?>" alt="" class="profile">
        </div>
        <div class="form-outline mb-4">
